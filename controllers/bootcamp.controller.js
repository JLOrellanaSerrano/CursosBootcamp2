// traigo los modelos desde la asociacón de tablas User y Bootcamp
...
// obtener las opciones de bootcamp por id
...
const addUserBootcamp = async (req, res) => {
  try {
    ...
    if (bootcamp && user) {
      ...
      res
        .status(201)
        .json({ message: "Usuario agregado exitosamente al Bootcamp" });
    } else {
